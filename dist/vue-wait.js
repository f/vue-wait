...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ \"./src/utils.js\");\n\n\nconst mutations = {\n  START: 'START',\n  END: 'END'\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  namespaced: true,\n  state: {\n    waitingFor: []\n  },\n  getters: {\n    is: state => waiter => Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"is\"])(state.waitingFor, waiter),\n    any: state => Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"any\"])(state.waitingFor)\n  },\n  actions: {\n    start: ({ commit }, waiter) => commit(mutations.START, waiter),\n    end: ({ commit }, waiter) => commit(mutations.END, waiter)\n  },\n  mutations: {\n    [mutations.START](state, waiter) {\n      state.waitingFor = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"start\"])(state.waitingFor, waiter);\n    },\n    [mutations.END](state, waiter) {\n      state.waitingFor = Object(_utils__WEBPACK_IMPORTED_MODULE_0__[\"end\"])(state.waitingFor, waiter);\n    }\n  }\n});\n\n\n//# sourceURL=webpack://VueWait/./src/vuex/store.js?");
